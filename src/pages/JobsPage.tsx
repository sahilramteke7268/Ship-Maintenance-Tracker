...
const JobsPage: React.FC = () => {
  ...
  const handleStatusUpdate = (jobId: string, newStatus: string) => {
    ...
    const updatedJob = { ...job, status: newStatus as 'Open' | 'In Progress' | 'Completed' };
    ...
    const notification = {
      ...
      type: newStatus === 'Completed' ? 'job-completed' as const : 'job-updated' as const,
  ...
  const handleCreateJob = (shipId?: string) => {
    if (shipId) {
